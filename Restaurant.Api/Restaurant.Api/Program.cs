...
using Restaurant.Application.Admin.Services.MenuItems.ActivateMenuItem;
using Restaurant.Application.Admin.Interfaces.MenuItems.DeactivateMenuItem;
using Restaurant.Application.Admin.Services.MenuItems.DeactivateMenuItem;
using Restaurant.Application.Admin.Interfaces.Staff.GetAllStaff;
using Restaurant.Application.Admin.Services.Staff.GetAllStaff;
using Restaurant.Application.Admin.Interfaces.Staff.GetStaffById;
using Restaurant.Application.Admin.Services.Staff.GetStaffById;
using Restaurant.Application.Admin.Interfaces.Staff.UpdateStaff;
using Restaurant.Application.Admin.Services.Staff.UpdateStaff;
using Restaurant.Application.Admin.Interfaces.Staff.SoftDeleteStaff;
using Restaurant.Application.Admin.Services.Staff.SoftDeleteStaff;
...
using Restaurnat.Infra.Admin.MenuItems.ActivateMenuItem;
using Restaurnat.Infra.Admin.MenuItems.DeactivateMenuItem;
using Restaurnat.Infra.Admin.Staff.GetAllStaff;
using Restaurnat.Infra.Admin.Staff.GetStaffById;
using Restaurnat.Infra.Admin.Staff.UpdateStaff;
using Restaurnat.Infra.Admin.Staff.SoftDeleteStaff;
...
namespace Restaurant.Api
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<Restaurant.Application.Admin.Interfaces.Categories.GetAllCategories.IGetAllCategoriesRepository, Restaurnat.Infra.Admin.Categories.GetAllCategories.GetAllCategoriesRepository>();
            ...
            builder.Services.AddScoped<Restaurant.Application.User.Interfaces.Categories.GetAllCategories.IGetAllCategoriesRepository, Restaurnat.Infra.User.Categories.GetAllCategories.GetAllCategoriesRepository>();
            ...
            builder.Services.AddScoped<IActivateMenuItemRepository, ActivateMenuItemRepository>();
            ...
            builder.Services.AddScoped<Restaurant.Application.Admin.Interfaces.Categories.GetAllCategories.IGetAllCategoriesService, Restaurant.Application.Admin.Services.Categories.GetAllCategories.GetAllCategoriesService>();
            ...
            builder.Services.AddScoped<Restaurant.Application.User.Interfaces.Categories.GetAllCategories.IGetAllCategoriesService, Restaurant.Application.User.Services.Categories.GetAllCategories.GetAllCategoriesService>();
            builder.Services.AddScoped<Restaurant.Application.User.Interfaces.MenuItems.GetMenuItemById.IGetMenuItemByIdService, Restaurant.Application.User.Services.MenuItems.GetMenuItemById.GetMenuItemByIdService>();
            builder.Services.AddScoped<Restaurant.Application.User.Interfaces.MenuItems.GetMenuItemById.IGetMenuItemByIdRepository, Restaurnat.Infra.User.MenuItems.GetMenuItemById.GetMenuItemByIdRepository>();
            ...
            builder.Services.AddScoped<IActivateMenuItemService, ActivateMenuItemService>();
